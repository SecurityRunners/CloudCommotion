...
This module creates a publicly accessible RDS instance. This module is not currently tested.
...
|------|-------------|------|---------|:--------:|
| <a name="input_allowed_ip"></a> [allowed\_ip](#input\_allowed\_ip) | List of IP addresses to allow access to the box | `string` | `"0.0.0.0/0"` | no |
| <a name="input_node_type"></a> [node\_type](#input\_node\_type) | The instance type to use for the instance | `string` | `"db.t2.micro"` | no |
